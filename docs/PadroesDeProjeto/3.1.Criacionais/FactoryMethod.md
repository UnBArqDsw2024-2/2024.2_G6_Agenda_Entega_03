...
class EventoBase(ABC):
    """
    Define a interface base para todos os tipos de eventos.
    """
    ...
    def get_prioridade(self) -> str:
        """
        Retorna a prioridade do evento. Este método deve ser implementado pelas subclasses.
        """
        pass

    def to_dict(self) -> dict:
        """
        Retorna o evento em formato de dicionário.
        """
        return {
            "titulo": self.titulo,
...
class EventoFactory(ABC):
    """
    Define a interface para criar objetos Evento.
    """
    @abstractmethod
    def criar_evento(self, titulo: str, data: str, local: Optional[str] = None,
        ...
        """
        Cria e retorna um objeto Evento. Este método deve ser implementado pelas subclasses.
        """
        pass
...
def criar_classe_evento(nome: str, prioridade: str) -> type:
    """
    Cria dinamicamente uma nova classe de evento que herda de EventoBase.
    """
    def get_prioridade(self) -> str:
        """
        Retorna a prioridade definida para a classe do evento.
        """
...
def criar_classe_factory(nome: str, classe_evento: type) -> type:
    """
    Cria dinamicamente uma nova classe factory que herda de EventoFactory.
    """
    def criar_evento(self, titulo: str, data: str, local: Optional[str] = None,
                    descricao: Optional[str] = None, lembrete: bool = False) -> EventoBase:
        """
        Cria e retorna um objeto Evento do tipo específico.
        """
